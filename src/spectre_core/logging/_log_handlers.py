...
class Log(TextHandler):
    ...
    def process_type(self) -> str:
        """Indicates the type of process, as defined by `ProcessTypes`."""
        return self._process_type


class Logs:
    """A managed collection of log files."""
    def __init__(self, 
        ...
        :param process_type: Filter by the process type, whether the process was user-initiated or created internally by `spectre`. Defaults to None.
    ...
    def update(self) -> None:
        ...
        for log_file in log_files:
            ...
            self._log_map[file_name] = Log(log_start_time, pid, ProcessTypes(process_type))
