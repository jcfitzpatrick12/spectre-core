...
def make_capture_template_swept_center_frequency(specs: Specs) -> CaptureTemplate:
...
class RSP1A(Receiver):
    ...
    def __init__(self, name: ReceiverName, mode: Optional[str] = None) -> None:
        ...
        self.add_mode(
            ...
            make_capture_template_fixed_center_frequency(self.specs),
            make_pvalidator_fixed_center_frequency(self.specs),
        )
        self.add_mode(
            ...
            make_capture_template_swept_center_frequency(self.specs),
            make_pvalidator_swept_center_frequency(self.specs),
        )
