...
class RSPduo(Base):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.add_mode(
            ...
            spectre_core.models.RSPduoFixedCenterFrequency,
            spectre_core.flowgraphs.RSPduoFixedCenterFrequency,
        ...
        self.add_mode(
            ...
            spectre_core.models.RSPduoSweptCenterFrequency,
            spectre_core.flowgraphs.RSPduoSweptCenterFrequency,
