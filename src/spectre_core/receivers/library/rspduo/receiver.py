...
#     def _set_capture_templates(self) -> None:
#         self._capture_templates = {
#             "tuner-1-fixed": self._get_default_capture_template("fixed"),
#             "tuner-1-sweep": self._get_default_capture_template("sweep"),
#             "tuner-2-fixed": self._get_default_capture_template("fixed"),
#             "tuner-2-sweep": self._get_default_capture_template("sweep"),
#         }
