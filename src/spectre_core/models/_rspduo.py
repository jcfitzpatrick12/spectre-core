...
class RSPduoFixedCenterFrequency(
    spectre_core.flowgraphs.RSPduoFixedCenterFrequencyModel,
    ...
    def validator(self, info: pydantic.ValidationInfo):
        ...
        validate_one_of(
            self.antenna_port,
            [
                spectre_core.flowgraphs.RSPduoPort.TUNER_1,
                spectre_core.flowgraphs.RSPduoPort.TUNER_2,
            ],
            name="antenna_port",
        )
...
class RSPduoSweptCenterFrequency(
    spectre_core.flowgraphs.RSPduoSweptCenterFrequencyModel,
