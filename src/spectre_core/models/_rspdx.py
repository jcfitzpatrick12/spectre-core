...
class RSPdxFixedCenterFrequency(
    spectre_core.flowgraphs.RSPdxFixedCenterFrequencyModel,
    ...
    def validator(self, info: pydantic.ValidationInfo):
        ...
        validate_one_of(
            self.antenna_port,
            [
                spectre_core.flowgraphs.RSPdxPort.ANT_A,
                spectre_core.flowgraphs.RSPdxPort.ANT_B,
            ],
            name="antenna_port",
        )
...
class RSPdxSweptCenterFrequency(
    spectre_core.flowgraphs.RSPdxSweptCenterFrequencyModel,
