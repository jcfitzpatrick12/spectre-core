...
from spectre_core.spectrograms.transform import time_average, frequency_average
...
from spectre_core.post_processing.base import BaseEventHandler, make_sft_instance
from spectre_core.post_processing.event_handler_register import register_event_handler
from spectre_core.chunks.library.swept_center_frequency.chunk import SweepMetadata
...
def build_spectrogram(chunk: BaseChunk,
                      capture_config: CaptureConfig,
...
class EventHandler(BaseEventHandler):
    ...
    def process(self, 
        ...
        spectrogram = build_spectrogram(chunk,
