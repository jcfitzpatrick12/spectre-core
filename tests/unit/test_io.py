...
class TestRead:
    def test_read_text(self, tmpdir: str) -> None:
        ...
        result = spectre_core.io.read_file(file_path, spectre_core.io.FileFormat.TEXT)
    ...
    def test_read_json(self, tmpdir: str) -> None:
        ...
        result = spectre_core.io.read_file(file_path, spectre_core.io.FileFormat.JSON)
    ...
    def test_read_png(self, tmpdir: str) -> None:
        ...
        result = spectre_core.io.read_file(file_path, spectre_core.io.FileFormat.PNG)
